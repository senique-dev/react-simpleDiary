...
function App() {
  ...
  // // 게시글 state를 boardData로 업데이트하면서 동시에 isDataLoaded 값을 true로 변경
  // useEffect(() => {
  //   (async () => {
  //     try {
  //       const response = await axios.get("/board/view/all");
  //       const boardData = response.data;
  //       dispatch({
  //         type: "INIT",
  //         data: boardData,
  //         // {bid, uid, kind, title, content, hits, cdatetime, udatetime}
  //       });
  //       setIsDataLoaded(true);
  //     } catch {
  //       console.log("ㄷㄷㄷ오류");
